...
png('Figures/depthFunctions.png', height = 6, width = 6, units = 'in', res = 500)
{
  plot(0,pch=NA,
       xlim = c(0,1),
       ylim = c(z_upp*1.5,0),
  ...
  lines(z~ BT_grd, col = 1, lty = 1, lwd = 3)
  lines(z~ BT_exp, col = 2, lty = 2, lwd = 3)
  lines(z_uni~ BT_all, col = 3, lty = 3, lwd = 3)
  
  legend('bottom', legend = c("Gradational", "Exponential", "Abrupt"), lty = c(1,2,3), col = c(1,2,3), ncol = 3,bty = 'n', lwd = 3)
};dev.off()
